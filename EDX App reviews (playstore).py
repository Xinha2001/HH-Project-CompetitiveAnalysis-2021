...
print(app_reviews) # Displays App Reviews with details such as Score given, Username, Date of reply, User Image, etc. 
...
app_reviews_df.to_csv('EDX App Reviews (Sorted).csv', index=None, header=True) #App reviews stored in a CSV file
